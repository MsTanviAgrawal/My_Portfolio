      ...
      <div className='project-carousel-container'>
        <div className='project-marquee-track'>
          ...
          <div className='project-slide-group'>
            {projects.map((project, index) => (
              <div className='project-card-wrapper' key={`track1-${index}`}>
                <div className='project-title'>
                  <h3>{project.title}</h3>
                  <p>{project.description}</p>
                  <div className='project-skills'>
          ...
          {/* Second Train Set (Cloned copy for perfect infinite continuity loop) */}
          <div className='project-slide-group' aria-hidden="true">
            {projects.map((project, index) => (
              <div className='project-card-wrapper' key={`track2-${index}`}>
                <div className='project-title'>
                  <h3>{project.title}</h3>
                  <p>{project.description}</p>
                  <div className='project-skills'>
